...
import { Calendar as CalendarIcon, Clock, Filter, Search, Download, MoreHorizontal } from 'lucide-react'
...
export default function AttendanceList() {
    const { data: attendances, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await api.getAttendances({ role: 'my_attendance' })
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Présences</h1>
            ...
            <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                    ...
                    <Input
                        placeholder="Rechercher une date ou un statut..."
                                    ...
                                    <tr key={attendance.id} className="hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-bold text-gray-900">{attendance.hours_worked || 0}h</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={cn(
